...
\texttt{docs/graphics-backend-feature-matrix.md}, Task~861). Combined-axis flip is not
...
you are porting existing 2D XNA/FNA game code (Volume~II's migration chapter), this is also
