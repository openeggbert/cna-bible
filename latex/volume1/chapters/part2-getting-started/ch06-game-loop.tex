...
callback. Volume~II's Web/Emscripten chapter covers this in full.
...
\section{GameComponentCollection: an event-raising collection, plus a real C\texttt{++} iterator surface}
...
an existing XNA or FNA game (Volume~II's migration chapter returns to this in practical
