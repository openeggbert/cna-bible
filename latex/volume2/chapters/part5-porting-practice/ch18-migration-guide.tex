...
Chapter~\ref{ch:design-philosophy} in Volume~I described for CNA's own internal porting work:
...
Volume~I's Part~IV gave a full per-backend account; for a porting decision specifically,
