...
Chapter~\ref{ch:design-philosophy} in Volume~I covered the code-level house style CNA
...
ASCII backend, Chapter~\ref{ch:canvas-ascii-backends} in Volume~I) and \texttt{plan\_cnj.md}
