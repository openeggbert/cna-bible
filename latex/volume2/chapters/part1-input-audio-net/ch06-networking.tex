...
mirroring the shape Volume~I's ecosystem chapter already summarized --- is one of the
...
already noted in Volume~I), wrapped by an internal \texttt{ENetBackend}.
...
a given multiplayer feature in a game you are porting (Volume~II's migration chapter returns
