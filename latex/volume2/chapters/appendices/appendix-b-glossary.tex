...
\item[.cnj] CNA's own permanent, JSON-based content sidecar format --- ``CNA content JSON,''
  ...
  native-format load in \cnaclass{ContentManager}'s resolution order. See Volume~I, Chapter~8.
\item[.xnb] Real XNA's compiled binary content-pipeline output format. CNA has a real, growing
  ...
  both a direct native-format load and \texttt{.cnj}. See Volume~I, Chapter~8, and this
  volume's migration guide, Chapter~18.
...
\item[Oracle (D3D9)] The pixel-for-pixel verification methodology comparing CNA's D3D9
  ...
  Volume~I, Chapter~22, and this volume's Windows/Wine chapter, Chapter~14.
...
\item[xna4-spec] The sibling repository providing a complete, machine-readable XML
  ...
  ground truth rather than against FNA's own source. See Chapter~20 of this volume.
\item[Storage] The \cnans{Microsoft::Xna::Framework::Storage} namespace --- a real, if
  ...
  underneath a faithfully-preserved fake-async API shape. See Chapter~8 of this volume.
\end{description}
