...
\texttt{Begin} / \texttt{End} pairs (Chapter~30), \cnaclass{NetworkSession}'s own async
operations (Chapter~31), \cnaclass{AvatarDescription::BeginGetFromGamer} (Chapter~32) --- and
...
\cnaclass{System::IO::Stream} (Chapter~35 covers \texttt{sharp-runtime}'s own \cnaclass{Stream}
