...
\cnaclass{MediaPlayer}\texttt{::Stop()}), and \texttt{Handle}, a NOXNA extension exposing the
...
hardcoded path guess --- with a NOXNA static override hook specifically so the test suite does
