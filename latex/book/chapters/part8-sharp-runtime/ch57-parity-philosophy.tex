...
Calling a gap permanent does not exempt its boundary from tests. \cnaclass{GC} no-ops should
remain callable; \cnaclass{Type}'s identity operations must work even though its classification
