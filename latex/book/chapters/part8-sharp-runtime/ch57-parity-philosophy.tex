...
contract} --- idempotent, non-throwing, and safe to call more than once --- and let the
...
The exception hierarchy this last block leans on is itself worth a precise count rather than a
vague gesture at ``lots of exception types'': a project-wide search finds 109 distinct
...
backward-compatibility hacks'' rule earlier in this book: a \texttt{getCurrent()} accessor was renamed
...
honestly (Chapter~\ref{ch:building-cna}): \texttt{sharp-runtime} has no tracked,
