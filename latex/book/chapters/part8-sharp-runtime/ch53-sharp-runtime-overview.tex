...
At the audited revision, \texttt{sharp-runtime} contains 1{,}037 public headers, 217
implementation files, and 78{,}934 lines of production C/C\texttt{++}. Its tests are larger
...
quality gate. Its local gate configures and builds under strict shell failure handling and
rejects compiler warnings and errors. The modular test topology is finer-grained than the old
