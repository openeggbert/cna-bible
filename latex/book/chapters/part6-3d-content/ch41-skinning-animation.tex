...
the current index throws. Looping uses floor-modulo on raw ticks, so negative or over-duration
times wrap consistently. Translations and scales interpolate linearly, rotations spherically.
Track search is linear in the number of keyframes per bone.
