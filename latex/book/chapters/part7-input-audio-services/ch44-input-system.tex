...
Two keys never reach ordinary game code through this pump: \texttt{F9} and \texttt{F10} are
hard-wired in \texttt{Game::PollEvents()} to simulate graphics-context loss and restoration.
Treat them as framework-reserved debug controls unless that game-loop behavior is changed.
