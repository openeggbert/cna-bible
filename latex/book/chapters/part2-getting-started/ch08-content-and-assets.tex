...
\cnaclass{VideoReader} follows the same broad architectural shape --- an external media reference
rather than an embedded stream --- but has its own five-field layout and extension set.  Its
reader-level path tests do not turn the Song fixture into evidence for video.
