...
\item[\cnaclass{AnimationPlayer}] The entire class, mirroring Microsoft's own unshipped XNA
  ...
  \texttt{GetWorldTransforms} / \texttt{GetSkinTransforms} --- Ch.12.
...
\texttt{AvatarRenderer::\allowbreak{}EnableReal\allowbreak{}RenderingEXT()}, \texttt{DrawRealEXT()},
\texttt{SetAppearanceEXT()}, \texttt{AvatarAnimation::\allowbreak{}SetRealClipNameEXT}/%
