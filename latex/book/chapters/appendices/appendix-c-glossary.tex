...
\item[GraphicsCapability] The small enum \cnaclass{GraphicsDevice::SupportsCapability} takes,
  ...
  \cnaclass{CustomEffects} have confirmed false positives; \cnaclass{ThreeD} does on ASCII,
  and \cnaclass{OcclusionQuery} does on WebGPU, SDL GPU, Software, and ASCII.
  \cnaclass{MultiSampleAntiAliasing} is definitely false-positive on ASCII and Software and
  fails to reflect several device-dependent clamps; \cnaclass{AnisotropicFiltering} is false
  on ASCII, SDL GPU, and Software and does not consult D3D9's live cap. See Chapters~9
  and~16 for the complete matrix.
