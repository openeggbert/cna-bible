...
regardless of which public renderer identity from Part~IV is actually doing the presenting.
...
with the game-facing source unchanged. Part~IV is dedicated to what actually
