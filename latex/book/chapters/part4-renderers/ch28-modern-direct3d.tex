...
All three of CNA's Windows-only Direct3D renderers share one development loop:
...
for all three alike, tracked as its own \texttt{needs\_human} task in each renderer's plan.
