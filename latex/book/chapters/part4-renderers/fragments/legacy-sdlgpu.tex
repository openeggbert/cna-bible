...
\texttt{shared\_ptr<SdlGpuRenderTarget2DState>}; explicit clears operate on the segment rather
...
(\texttt{modules/renderers/sdl-gpu/examples/CMakeLists.txt}) rather than trusting an old plan
