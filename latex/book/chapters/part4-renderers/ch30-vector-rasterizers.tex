...
\subsection{A worked example: one narrow positive capability among explicit refusals}
...
\section{The Phase 70 audit: fifteen real bugs, followed by later contract repairs}
\label{sec:phase70-audit-bugs}

The single most thorough renderer audit in the project (Tasks~666--730, 65 technical tasks,
followed by Task~731's closing document) found and fixed fifteen real bugs, spanning almost
every area \cnaclass{SpriteBatch} touches:
