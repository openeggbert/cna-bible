...
\texttt{OPENGL33}, \texttt{WEBGL1}, and \texttt{WEBGL2}. That implementation family uses a
two-library stack. \texttt{meta-gl} owns loading, typed calls, context facts, and validation;
...
and in the source: 18 production files include \texttt{meta-gl} headers directly, comprising
three public headers and fifteen implementation files. The layering is worth remembering
...
\section{Capability gating by feature, not version}
...
\section{Design corrections and one breaking change}
...
\subsection{Four focused RAII additions}
...
\section{Two tiers of context-loss recovery}
