...
looks for them there. This chapter is the map; later chapters (and all of Part~VII)
are the territory.
...
than a guess. Chapter references in Part~VI cover \texttt{sharp-runtime}'s own
...
Part~VII cover its public API surface (\texttt{easygl::Device},
...
in Part~VII and in the Speedy Blupi/Planet Blupi porting case study in Part~IX.
...
Chapter references in Part~IX walk through using \texttt{xna4-spec} to run this kind
of audit yourself.
