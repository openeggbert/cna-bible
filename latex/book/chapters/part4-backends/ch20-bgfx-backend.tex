...
of which has its own dedicated instancing test (\texttt{d3d9\_instanced\_test.cpp},
\texttt{easygl\_instancedmodel\_shader\_test.cpp}, \texttt{vulkan\_instanced\_test.cpp},
\texttt{webgpu\_instanced3d\_test.cpp}). This backend is the one real gap in that otherwise
complete cross-backend picture --- implemented, never independently pixel-verified.
