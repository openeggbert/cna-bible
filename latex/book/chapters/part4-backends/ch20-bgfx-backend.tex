...
\cnaclass{GraphicsDevice}\allowbreak{}\texttt{::DrawInstancedPrimitives()} is real and fully
wired on this backend --- \texttt{BgfxGraphicsBackend::DrawInstancedPrimitivesEx()} is a
