...
\subsection{The one real gap this correction actually leaves standing: \texttt{SetDataRaw}}
...
vertex data round-trips correctly through \texttt{GetData} on this backend exactly like every
other one, and only the \texttt{NOXNA} custom-layout extension point that Task~1080 added is
where a real readback gap survives.
