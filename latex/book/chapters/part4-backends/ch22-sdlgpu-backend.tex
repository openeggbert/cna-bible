...
Seven limits are worth stating precisely rather than glossing over. First, occlusion queries are a
...
the pointer dangling, despite the separately fixed queued-draw state lifetime. Beyond these
seven, Windows (D3D12 driver) and macOS/iOS (Metal driver)
