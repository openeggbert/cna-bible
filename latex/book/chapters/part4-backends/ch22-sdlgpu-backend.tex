...
Five limits are worth stating precisely rather than glossing over. First, occlusion queries are a
...
pipeline cache. Beyond these five, Windows (D3D12 driver) and macOS/iOS (Metal driver)
