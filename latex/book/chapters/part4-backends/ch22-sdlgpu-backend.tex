...
Four limits are worth stating precisely rather than glossing over. First, occlusion queries are a
...
Beyond these four, Windows (D3D12 driver) and macOS/iOS (Metal driver)
