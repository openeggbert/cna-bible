...
Six limits are worth stating precisely rather than glossing over. First, occlusion queries are a
...
but not included in command or sampler-cache creation, so no SDL\_gpu sampler uses it. Beyond
these six, Windows (D3D12 driver) and macOS/iOS (Metal driver)
