...
auto-clearing to black on every rebind needed \emph{zero} DX3-specific code at all --- it
...
documents for other backends. \texttt{SetRenderTargets()} with two or more bindings throws, honestly:
