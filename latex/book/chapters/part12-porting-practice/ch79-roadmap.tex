...
CNA already exposes 46 identities across 42 families.  The next renderer milestone is not a
...
\section{Finish glTF semantics, not just import coverage}
...
Android needs a fresh graphics build and emulator frame before any renderer is claimed.  Retain
...
that 42 means public identities, or that old source paths still register gates.  Generate renderer
