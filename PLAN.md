...
`main.pdf` is 519 pages; the targeted undefined-reference and duplicate-label checks are empty;
makeindex accepted 2,119 entries with no rejection or warning. The affected physical pages
