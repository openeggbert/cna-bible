...
ContentManager cache/disposal, copy/replacement, service-provider/device-resolution, and
reader-registration audits. `main.pdf` is 529 pages; the targeted undefined-reference and
duplicate-label checks are empty; makeindex accepted 2,142 entries with no rejection or warning.
