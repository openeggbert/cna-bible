...
resource-lifecycle, and construction/SDL-ownership audits. `main.pdf` is 521 pages; the targeted
undefined-reference and duplicate-label checks are empty; makeindex accepted 2,123 entries with
no rejection or warning. Current physical pages 110--111 and 126--127 were rendered and inspected.
...
resource-lifecycle, and one construction-drafting box without repeating that global comparison
