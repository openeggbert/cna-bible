...
- **2026-07-24, continued — Appendix E fourth pass, pending verification.** Added the
  source-verified `SkinnedPbrEffect`/`SkinnedPbrEffect` layout relationship and clarified that
  ...
  Appendix E or changing that status.
