...
ContentManager cache/disposal audits. `main.pdf` is 525 pages; the targeted undefined-reference
and duplicate-label checks are empty; makeindex accepted 2,140 entries with no rejection or
warning. Current physical pages 50, 58--59, 60, 63--64, 105--106, 110--111, 115--116,
