...
**Status: Phase 1 execution is active. The current book is 571 physical PDF pages
...
`main.pdf` is 571 pages; the targeted undefined-reference and duplicate-label checks are empty;
makeindex accepted 2,361 entries with no
