...
concurrency/reentrancy, content-manifest introspection, and format-selection/fallback audits.
`main.pdf` is 535 pages; the targeted undefined-reference and duplicate-label checks are empty;
makeindex accepted 2,143 entries with no
