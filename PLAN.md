...
ContentManager cache/disposal and copy/replacement audits. `main.pdf` is 527 pages; the targeted
undefined-reference and duplicate-label checks are empty; makeindex accepted 2,141 entries with
no rejection or warning. Current physical pages 50, 58--59, 60, 63--64, 106--107, 110--111, 115--116,
