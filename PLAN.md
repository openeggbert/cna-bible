...
**Status: Phase 1 execution is active. The current book is 573 physical PDF pages
...
`main.pdf` is 573 pages; the targeted undefined-reference and duplicate-label checks are empty;
makeindex accepted 2,364 entries with no
